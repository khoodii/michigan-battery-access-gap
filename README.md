...
32 of 83 Michigan counties have zero battery drop-off sites, and the gap tracks income, not demand. The lowest income quartile averages 0.38 sites per county. The highest averages 6.19.

## Why This Matters

Lithium battery fires at waste facilities hit an all-time high in 2025, with 448 incidents across the US and Canada. Michigan is already seeing it: a battery fire in a Troy trash truck in May 2025, monthly fires reported at Grand Rapids recycling facilities. Awareness is not the bottleneck. 95% of residents report at least one barrier to recycling, and in 32 counties the barrier is that there is nowhere to go.
...
- **Multi-source verification.** The original analysis relied solely on the Battery Network locator, which captures retail partners only. A follow-up audit cross-referenced EGLE's county facility directory, conservation district websites, and local government pages to identify county-run programs the locator misses. Six counties were reclassified from deserts to served.
...
| --- | --- | --- | --- |
| Q1 Lowest | 0.38 | 1.16 | 14 of 21 |
| Q2 | 2.38 | 1.98 | 11 of 21 |
| Q3 | 1.60 | 2.16 | 5 of 20 |
| Q4 Highest | 6.19 | 3.26 | 2 of 21 |
...
Place collection sites at food pantries and libraries in the 32 desert counties. These are trusted community anchors already visited by the most underserved residents, so recycling embeds into existing routines instead of requiring a separate trip. The Battery Network provides collection boxes and recycling logistics at no cost to host sites, so the barrier is coordination, not equipment.

**A self-funding model.** Borrowing the principle behind LifeStraw's Buy One Give One, each Q4 site contributes a proportional amount to fund a desert county site. At $500 per Q4 site across 130 active Q4 locations, the program generates $65,000 a year. At $1,000 per desert site, that covers all 32 target counties with a $33,000 surplus. No legislation, government funding, or new infrastructure required.

## Data Sources

- Battery Network internal API (214 scraped drop-off locations, original dataset)
- EGLE County Recycling & HHW Contact List (multi-source verification)
