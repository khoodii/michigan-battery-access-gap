-- ================================================================
-- Michigan Battery Access Analysis — v3 (with RUCC rural/urban)
...
INSERT INTO county_access VALUES
    ('Iosco', 47777, 0, 'Q1_lowest', 25054, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Montmorency', 47803, 0, 'Q1_lowest', 9261, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Gogebic', 49672, 0, 'Q1_lowest', 14526, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Lake', 49680, 0, 'Q1_lowest', 11853, 0.0, 'MI', 8, 'Nonmetro', 'Rural'),
    ('Clare', 49805, 1, 'Q1_lowest', 30608, 3.27, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Oscoda', 50581, 0, 'Q1_lowest', 8241, 0.0, 'MI', 9, 'Nonmetro', 'Rural'),
    ('Ontonagon', 51844, 0, 'Q1_lowest', 5951, 0.0, 'MI', 9, 'Nonmetro', 'Rural'),
    ('Alpena', 51909, 0, 'Q1_lowest', 28573, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Ogemaw', 51983, 1, 'Q1_lowest', 21024, 4.76, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Alcona', 53568, 0, 'Q1_lowest', 10234, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Iron', 53614, 0, 'Q1_lowest', 11228, 0.0, 'MI', 8, 'Nonmetro', 'Rural'),
    ('Isabella', 53759, 2, 'Q1_lowest', 70311, 2.84, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Keweenaw', 53893, 0, 'Q1_lowest', 2103, 0.0, 'MI', 9, 'Nonmetro', 'Rural'),
    ('Roscommon', 54106, 0, 'Q1_lowest', 23766, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Luce', 54338, 0, 'Q1_lowest', 6230, 0.0, 'MI', 9, 'Nonmetro', 'Rural'),
    ('Delta', 54829, 0, 'Q1_lowest', 35784, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Baraga', 55117, 0, 'Q1_lowest', 8209, 0.0, 'MI', 8, 'Nonmetro', 'Rural'),
    ('Gladwin', 55576, 0, 'Q1_lowest', 25289, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Menominee', 55688, 1, 'Q1_lowest', 22893, 4.37, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Houghton', 56573, 1, 'Q1_lowest', 35684, 2.8, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Presque Isle', 56713, 0, 'Q1_lowest', 12592, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Huron', 56963, 0, 'Q2', 30981, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Arenac', 56989, 0, 'Q2', 14694, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Osceola', 57050, 0, 'Q2', 23460, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Schoolcraft', 57708, 0, 'Q2', 7989, 0.0, 'MI', 8, 'Nonmetro', 'Rural'),
    ('Mecosta', 57774, 0, 'Q2', 43240, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Saginaw', 58347, 6, 'Q2', 190539, 3.15, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Mackinac', 58598, 1, 'Q2', 10799, 9.26, 'MI', 8, 'Nonmetro', 'Rural'),
    ('Crawford', 58614, 0, 'Q2', 14030, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Sanilac', 59074, 0, 'Q2', 41170, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Alger', 59406, 0, 'Q2', 9069, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Wayne', 59521, 23, 'Q2', 1734013, 1.33, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Kalkaska', 60365, 0, 'Q2', 18038, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Calhoun', 60385, 4, 'Q2', 134159, 2.98, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Bay', 60523, 2, 'Q2', 103126, 1.94, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Chippewa', 60631, 0, 'Q2', 37354, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Genesee', 60673, 7, 'Q2', 405813, 1.72, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Hillsdale', 60869, 0, 'Q2', 45830, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Manistee', 60879, 0, 'Q2', 24397, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Gratiot', 61128, 1, 'Q2', 40347, 2.48, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Cheboygan', 61619, 0, 'Q2', 26152, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Missaukee', 61868, 0, 'Q2', 15453, 0.0, 'MI', 7, 'Nonmetro', 'Rural'),
    ('Dickinson', 61882, 1, 'Q3', 25554, 3.91, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Newaygo', 61931, 0, 'Q3', 49654, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Branch', 61958, 1, 'Q3', 43517, 2.3, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Mason', 62296, 0, 'Q3', 29449, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Tuscola', 62847, 1, 'Q3', 52245, 1.91, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Wexford', 63123, 1, 'Q3', 34152, 2.93, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Berrien', 63152, 3, 'Q3', 153696, 1.95, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Muskegon', 63495, 3, 'Q3', 176492, 1.7, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Oceana', 63624, 1, 'Q3', 26467, 3.78, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Ingham', 64354, 5, 'Q3', 292406, 1.71, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Shiawassee', 64464, 1, 'Q3', 68122, 1.47, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Marquette', 64675, 4, 'Q3', 66657, 6.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('St. Joseph', 64707, 1, 'Q3', 60964, 1.64, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Montcalm', 64892, 0, 'Q3', 63888, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Jackson', 65004, 2, 'Q3', 158510, 1.26, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Van Buren', 66902, 0, 'Q3', 76258, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Lenawee', 67013, 2, 'Q3', 98451, 2.03, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Otsego', 67285, 2, 'Q3', 24397, 8.2, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Cass', 68011, 0, 'Q3', 51547, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('St. Clair', 69349, 4, 'Q3', 159415, 2.51, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Kalamazoo', 70525, 6, 'Q4_highest', 265066, 2.26, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Antrim', 71421, 1, 'Q4_highest', 23624, 4.23, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Benzie', 72603, 0, 'Q4_highest', 17766, 0.0, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Ionia', 73436, 1, 'Q4_highest', 64697, 1.55, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Emmet', 73724, 4, 'Q4_highest', 33895, 11.8, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Monroe', 75272, 2, 'Q4_highest', 150500, 1.33, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Lapeer', 76228, 1, 'Q4_highest', 89843, 1.11, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Macomb', 76399, 17, 'Q4_highest', 881217, 1.93, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Charlevoix', 76495, 1, 'Q4_highest', 26856, 3.72, 'MI', 6, 'Nonmetro', 'Suburban/Small City'),
    ('Midland', 77538, 6, 'Q4_highest', 82874, 7.24, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Barry', 77873, 0, 'Q4_highest', 61550, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Eaton', 78025, 3, 'Q4_highest', 110268, 2.72, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Grand Traverse', 79486, 10, 'Q4_highest', 97519, 10.25, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Allegan', 80255, 1, 'Q4_highest', 118081, 0.85, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Kent', 80390, 16, 'Q4_highest', 667415, 2.4, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Clinton', 85928, 1, 'Q4_highest', 79594, 1.26, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Ottawa', 87144, 10, 'Q4_highest', 305134, 3.28, 'MI', 2, 'Metro', 'Urban/Metro'),
    ('Washtenaw', 87156, 8, 'Q4_highest', 375329, 2.13, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Leelanau', 91943, 0, 'Q4_highest', 22355, 0.0, 'MI', 3, 'Metro', 'Urban/Metro'),
    ('Oakland', 95296, 37, 'Q4_highest', 1274395, 2.9, 'MI', 1, 'Metro', 'Urban/Metro'),
    ('Livingston', 101315, 4, 'Q4_highest', 202909, 1.97, 'MI', 1, 'Metro', 'Urban/Metro');
